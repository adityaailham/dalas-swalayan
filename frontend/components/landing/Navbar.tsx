...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between px-8 md:px-16 py-4 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-100 sticky top-0 z-50 transition-all duration-300">
      ...
      <Link href="/#informasi">
        <button className="bg-orange-500 hover:bg-orange-600 transition-colors text-white px-6 py-2 rounded-md md:rounded-full font-medium text-base cursor-pointer">
          Kontak Kami
        </button>
      </Link>
    </nav>
